...
const TestComponent = () => {
  ...
  return (
    <div>
      ...
      <button onClick={() => startTimer(30, 'Green Tea', 0, 'test-tea-1', 3)}>Start Timer</button>
      <button onClick={() => startTimer(5, 'Black Tea', 1, 'test-tea-2', 3)}>Start 5s Timer</button>
        ...
        return (
          <div>
            ...
            <button
              ...
              onClick={() => startTimer(45, 'Custom Tea', 0, 'test-tea-3', 5)}
            >
              Custom Start
            </button>
          </div>
